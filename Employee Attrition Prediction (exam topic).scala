...
// MAGIC %md
// MAGIC
// MAGIC So what is Attrition and what determines it?
// MAGIC
// MAGIC **Attrition:** It is basically the turnover rate of employees inside an organization. 
// MAGIC
// MAGIC This can happen for many reasons:
// MAGIC
// MAGIC * Employees looking for better opportunities.
// MAGIC * A negative working environment.
// MAGIC * Bad management
// MAGIC * Sickness of an employee (or even death)
// MAGIC * Excessive working hours
// MAGIC
// MAGIC

// COMMAND ----------

// DBTITLE 1,Structure of the Project:
// MAGIC %md
// MAGIC
// MAGIC This project will be structured in the following way:
// MAGIC
// MAGIC * **Questions:** Questions will be asked previous to the visualization to make sure the visualizations shown in this project are insightful.
// MAGIC * **Summary:** After each section we will provide a summary to understand what we got from the visualizations.
// MAGIC * **Recommendations:** What recommendations could be given to the organization to reduce the attrition rate.
...
// MAGIC %md
// MAGIC
// MAGIC #### I. General Information: 
// MAGIC
// MAGIC * a) Summary of our Data
// MAGIC * b) Distribution of our Labels
// MAGIC
// MAGIC
...
// MAGIC %md 
// MAGIC
// MAGIC #### II. Gender Analysis: 
// MAGIC * a) Age Distribution by Gender
// MAGIC * b) Job Satisfaction Distribution by Gender
// MAGIC * c) Monthly Income by Gender 
// MAGIC * d) Presence by Department 

// COMMAND ----------

// MAGIC %md
// MAGIC
// MAGIC #### III.Analysis by Genderation and Education:
// MAGIC * a) Generational Behavior
// MAGIC * b) Understanding Attrition by Generation

// COMMAND ----------

// MAGIC %md
// MAGIC
// MAGIC #### IV. The Impact of Income towards Attrition:
// MAGIC * a) Average income by Department
// MAGIC * b) Determining Satisfaction by Income
// MAGIC * c) Average Daily Rates and Percent Difference
// MAGIC * d) Level of Attrition by Overtime

// COMMAND ----------

// MAGIC %md
// MAGIC
// MAGIC #### V. Working Environment: 
// MAGIC * a) Median Salary by Job Role
// MAGIC * b) Attrition by Job Role
// MAGIC * c) Current Managers and Average Satisfaction Score
// MAGIC *  d) Average Environment Satisfaction

// COMMAND ----------

// MAGIC %md
// MAGIC
// MAGIC #### VI. An In-depth Look into Attrition: 
// MAGIC * a) Digging into Attrition
// MAGIC * b) Other Factors that could Influence Attrition

// COMMAND ----------

// MAGIC %md
// MAGIC
// MAGIC #### VII. Analysis and Models
// MAGIC
// MAGIC * a) Starting with Decision Trees

// COMMAND ----------

// MAGIC %md
// MAGIC
// MAGIC ####VIII. Conclusion
// MAGIC * a) Top Reasons why Employees Leave the Organization

// COMMAND ----------

// MAGIC %md ### Load Source Data
// MAGIC The data for this project is provided as a CSV file containing details of employee. The data includes specific characteristics (or *features*) for each employee, as well as a column(Attrition) indicating how many employee has left the organization.
// MAGIC
